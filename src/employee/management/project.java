...
public class project extends JFrame implements ActionListener {
    ...
    project()
    {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("pictures/back3.png"));
        Image i2 = i1.getImage().getScaledInstance(1600,802,Image.SCALE_DEFAULT);
        ...
        JMenuItem s41 = new JMenuItem("Leave Entry");

        s41.setForeground(Color.blue);
        s41.setFont(new Font("monospaced",Font.PLAIN,12));
        s41.setMnemonic('Y');
        s41.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/EXPENSE2.PNG")));
        s41.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T, ActionEvent.CTRL_MASK));
        ...
        rep.add(p2);
        JMenuItem p3 = new JMenuItem("Leave Record");
   
        p3.setForeground(Color.blue);
        p3.setFont(new Font("monospaced",Font.PLAIN,12));
        p3.setMnemonic('W');
        p3.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/pass.png")));
        p3.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, ActionEvent.CTRL_MASK));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        else if(msg.equals("Leave Entry")){
            new TakeLeave().setVisible(true);
        }
        ...
        else if(msg.equals("Leave Record"))
